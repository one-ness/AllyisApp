...
namespace AllyisApps.Services.Auth
{
    ...
    public class UserAccount
    {
        ...
        /// <param name="organizaionsInfo"></param>
        /// <param name="subscriptions"></param>
        /// <param name="invitations"></param>
        public UserAccount(
            dynamic user, IEnumerable<dynamic> organizaionsInfo,
            IEnumerable<dynamic> subscriptions,
            IEnumerable<dynamic> invitations)
        {
            userInfo = AppService.InitializeUser(user);
            Organizations = new List<OrganizationAndRole>();
            foreach(dynamic org in organizaionsInfo)
            {
            ...
            foreach (dynamic invite in invitations)
            {
