...
namespace AllyisApps.Controllers.Auth
{
	...
	public partial class AccountController : BaseController
	{
		...
		public async Task<ActionResult> EditProfile(EditProfileViewModel model)
		{
			...
			{
				await this.AppService.UpdateCurrentUserProfile(model.DateOfBirth, model.FirstName, model.LastName, model.PhoneNumber, model.Address, model.City, model.SelectedStateId, model.PostalCode, model.SelectedCountryCode);
