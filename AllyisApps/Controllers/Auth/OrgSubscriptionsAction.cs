...
namespace AllyisApps.Controllers.Auth
{
	...
	public partial class AccountController : BaseController
	{
		...
		public async Task<ActionResult> OrgSubscriptions(int id)
		{
			...
			model.CanEditSubscriptions = await AppService.CheckPermissionAsync(ProductIdEnum.AllyisApps, AppService.UserAction.Edit, AppService.AppEntity.Subscription, id, false);
			model.CanManagePermissions = await AppService.CheckPermissionAsync(ProductIdEnum.AllyisApps, AppService.UserAction.Edit, AppService.AppEntity.Permission, id, false);
