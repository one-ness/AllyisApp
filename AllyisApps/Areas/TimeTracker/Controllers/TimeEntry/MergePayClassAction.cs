...
namespace AllyisApps.Areas.TimeTracker.Controllers
{
	...
	public partial class TimeEntryController : BaseController
	{
		...
		public async Task<ActionResult> MergePayClass(int subscriptionId, int userId)
		{
			...
			if (sourcePayClass.BuiltInPayClassId != (int)BuiltinPayClassIdEnum.Custom)
			{
			...
			var model = new MergePayClassViewModel
			{
				...
				DestinationPayClasses = destPayClasses.Where(payc => payc.BuiltInPayClassId != ((int)BuiltinPayClassIdEnum.OverTime)).Select(payclass => new PayClassInfoViewModel(payclass))
			};
		...
		public async Task<ActionResult> MergePayClass(MergePayClassViewModel model, int destPayClass)
		{
			try
			{
				...
				if (paylcasses[destPayClass].BuiltInPayClassId == (int)BuiltinPayClassIdEnum.OverTime)
				{
				...
				if (paylcasses[destPayClass].BuiltInPayClassId == (int)BuiltinPayClassIdEnum.Regular)
				{
					//upadate over time 
