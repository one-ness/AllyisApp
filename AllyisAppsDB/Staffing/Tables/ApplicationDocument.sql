CREATE TABLE [Staffing].[ApplicationDocument] (
	...
	CONSTRAINT [PK_ApplicationDocument_Application] FOREIGN KEY ([ApplicationId]) REFERENCES [Staffing].[Application]([ApplicationId]) ON DELETE CASCADE
);
