CREATE TABLE [Staffing].[Position] (
	...
	[PositionStatusId]				INT				 CONSTRAINT [DF_Position_PositionStatus] DEFAULT ((0)) NULL,
	[PositionTitle]					NVARCHAR (140)   NOT NULL,
	[BillingRateFrequency]			INT				 NULL,
	[BillingRateAmount]				INT				 NULL,
	[DurationMonths]				INT				 NULL,
	[EmploymentTypeId]				INT				 CONSTRAINT [DF_Position_EmploymentType] DEFAULT ((0)) NULL,
	...
	[PositionLevelId]				INT				 CONSTRAINT [DF_Position_PositionLevel] DEFAULT ((0)) NULL,
	...
	CONSTRAINT [FK_Position_PositionStatus] FOREIGN KEY ([PositionStatusId]) REFERENCES [Staffing].[PositionStatus] ([PositionStatusId]),
	CONSTRAINT [FK_Position_PositionLevel] FOREIGN KEY ([PositionLevelId]) REFERENCES [Staffing].[PositionLevel] ([PositionLevelId]),
	CONSTRAINT [FK_Position_EmploymentType] FOREIGN KEY ([EmploymentTypeId]) REFERENCES [Staffing].[EmploymentType] ([EmploymentTypeId])
);

GO
	CREATE UNIQUE NONCLUSTERED INDEX
	[IX_AddressId]
		ON [Staffing].[Position]([AddressId] ASC)
