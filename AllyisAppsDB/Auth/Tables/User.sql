CREATE TABLE [Auth].[User] (
	...
	[IsEmailConfirmed]			BIT              CONSTRAINT [DF__User__EmailConfi__66603565] DEFAULT ((0)) NOT NULL,
	[IsPhoneNumberConfirmed]	BIT              CONSTRAINT [DF__User__PhoneNumbe__6754599E] DEFAULT ((0)) NOT NULL,
