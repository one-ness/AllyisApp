CREATE TABLE [Expense].[ExpenseReport] (
    ...
    [CreatedUtc]            DATETIME2 (0)  CONSTRAINT [DF_ExpenseReport_CreatedUtc] DEFAULT (getutcdate()) NOT NULL,
    [ModifiedUtc]           DATETIME2 (0)  CONSTRAINT [DF_ExpenseReport_ModifiedUtc] DEFAULT (getutcdate()) NOT NULL,
